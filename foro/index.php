        ...
        <article class="col-md-6">
            <form action="registro.php" method="POST" role="form">
                ...
                <div class="form-group ">
                    ...
                    <label class="login-field-icon usuario" ></label>
                </div>
                <div class="form-group ">
                    <input class="form-control" type='email' name='email' placeholder="Email" required/>
                    <label class="login-field-icon correo" ></label>
                </div>
                <div class="form-group ">
                    <input class="form-control" type='password' name='contrasena' placeholder="Contraseña"/>
                    <label class="login-field-icon candado" ></label>
                </div>
               <button class="btn btn-primary registrar" type='submit' name='enviar'/> Registrar</button>
                </div>
            </form> 
        </article>
        <article class="col-md-6">
            <form action="login.php" method="POST" role="form">
               ...
               <button class="btn btn-primary entrar" type='submit' name='login'/> Entrar</button>
                </div>
            </form> 
        </article>
    </section>
